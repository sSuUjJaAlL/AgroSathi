...
const NEPAL_FACTS = [
  ...
  "This app tracks 8 Kalimati commodities: apple, lemon, ginger, carrot, garlic green, dry chilli, red potato, and tomato.",
  ...
  "Green garlic (hariyo lasun) is a staple seasoning — prices spike in winter when fresh supply is thin.",
  "Dry chilli (sukkako khursani) prices often rise before Dashain/Tihar when demand for pickles surges.",
